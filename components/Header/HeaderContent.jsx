...
const HeaderContent = () => {
  ...
  const { listCount } = useWishlistContext();
  ...
  return (
    <div className="bg-primary text-white w-full h-[57px] md:h-20 grid place-items-center px-3">
      <nav className="container flex items-center justify-between h-full gap-8 lg:gap-2 ">
        <div>
          <Image src="/img/FooterImg/logo1.png" alt="logo" srcset="" className="h-15" width={200} height={100} />
        </div>
            ...
            <li className="hover:bg-slate-200/15 px-1 py-2 rounded-lg duration-300 ">
              ...
              >
                ...
                <div className="text-white flex flex-col">
                  <span>Offer</span>
                  <p className="text-xs text-gray-500 mt-[-1px] hidden lg:block ">
                    Latest Offer
                  </p>
                </div>
              </Link>
